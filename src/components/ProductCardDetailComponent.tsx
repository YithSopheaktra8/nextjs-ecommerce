...
export default function ProductCardDetailComponent({
	image,
	category,
	name,
	desc,
		...
		<div className="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4 ">
			<div className="flex justify-center items-center lg:flex-row flex-col gap-16">
				...
				<div className="  w-full sm:w-96 md:w-8/12 lg:w-6/12 items-center">
					...
					<button className="focus:outline-none focus:ring-2 rounded-lg hover:bg-black focus:ring-offset-2 focus:ring-gray-800 font-medium text-base leading-4 text-white bg-gray-800 w-full py-5 lg:mt-12 mt-6">
						Add to shopping bag
					</button>
				</div>
				...
				<div className=" w-full sm:w-96 md:w-8/12  lg:w-6/12 flex lg:flex-row flex-col lg:gap-8 sm:gap-6 gap-4">
					<div className=" h-[500px] w-full lg:w-8/12 bg-gray-100 flex justify-center items-center">
						<img
							src={image}
							alt={name}
