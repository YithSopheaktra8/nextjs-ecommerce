				...
				<div className="w-full flex flex-col justify-center items-center">
					<div className="flex flex-col justify-center items-center text-center space-y-4">
						...
						<p className="text-base leading-6 text-center dark:text-gray-400 text-gray-600 w-full md:w-10/12">
							Here are few of the most frequently asked questions
							by our valueable customers
						</p>
					</div>
					...
					<div className="mt-16 flex justify-start flex-col items-start w-full text-left space-y-8">
						<div className="flex justify-start items-start flex-col text-left w-full xl:w-8/12">
							...
							<p className="mt-6 text-base leading-6 dark:text-gray-400 text-gray-600">
								...
								delivered within 7 to 10 business days,
						...
						<div className="flex justify-start items-start flex-col text-left w-full xl:w-8/12">
							...
							<p className="mt-6 text-base leading-6 dark:text-gray-400 text-gray-600">
								Remeber you can query the staus of your oders
								any time in My orders in the My aacount
								section.l if you are not resigered at Mango.com,
								you can access dierectly in the Orders section.
								In this cause, you will have enter your em-mail
						...
						<div className="flex justify-start items-start flex-col text-left w-full xl:w-8/12">
							...
							<p className="mt-6 text-base leading-6 dark:text-gray-400 text-gray-600">
								Yes, you can change or cancel your order within
								the first 10 days of your order placement.
							</p>
						</div>
						<hr className="border border-gray-100 w-full" />
					</div>
